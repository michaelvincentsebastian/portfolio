      ...
      technical: {
        en: {
          ...
          components: [
            ...
            { id: "c4", icon: "Brain", title: "Local AI (Ollama)", summary: "Semantic reasoning & course matching", detail: "Utilizes small language models (smollm2 1.7b via Ollama) to semantically match student profiles (major and career) with relevant course catalogs without relying on heavy cloud AI costs." },
            { id: "c5", icon: "GitBranch", title: "Openclaw Agent", summary: "Operational orchestration & alerting", detail: "Deployed in Docker and use Openrouter AI Model Provider (use nvidia/nemotron-3-nano-30b-a3b:free with rate-limit 50 request per day), the Openclaw Agent schedules Python scripts and SQLMesh plans. It runs the tryout regression checks and triggers Telegram bot notifications if any pipeline or alert process fails." },
          ],
          pipelineLayers: [
            ...
            { name: "Gold Layer (Ready to Use)", items: ["Calculate score trends using REGR_SLOPE", "Aggregate final clean tables", "Serve via Flask API to Web App", "Trigger Openclaw email alerts"], color: "bg-yellow-500/10", borderColor: "border-yellow-500/30" },
          ],
          techStack: [
            { name: "DuckDB", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/duckdb/duckdb-original.svg" },
            { name: "SQLMesh", icon: "https://cdn.prod.website-files.com/67f7cdf0feddc96ca194ff1a/67f7cdf0feddc96ca1950030_symbol-sqlmesh.svg" },
      ...
      result: {
        en: {
          ...
          screenshots: [
            ...
            { src: "/images/projects/futuramap-profil-1.jpg", alt: "FuturaMap Student Profile", caption: "Student Profiling — Aggregated data from Andalan School LMS" },
            { src: "/images/projects/futuramap-tryout-1.jpg", alt: "FuturaMap Tryout 1", caption: "Dashboard Analitik Tren dan Gap Nilai Tryout SNBT" },
            { src: "/images/projects/futuramap-tryout-2.jpg", alt: "FuturaMap Tryout 2", caption: "Overall score trend visualization dashboard" },
            { src: "/images/projects/futuramap-tryout-3.jpg", alt: "FuturaMap Tryout 3", caption: "Detailed student performance per sub-test" },
            { src: "/images/projects/futuramap-tryout-4.jpg", alt: "FuturaMap Tryout 4", caption: "Student tryout review interface" },
            { src: "/images/projects/futuramap-tryout-5.jpg", alt: "FuturaMap Tryout 5", caption: "Corrective feedback and answer review for students" },
            { src: "/images/projects/futuramap-kursus-1.jpg", alt: "FuturaMap Course Recommendation", caption: "AI Generated Course Recommendations" },
        ...
        id: {
          ...
          screenshots: [
            ...
            { src: "/images/projects/futuramap-profil-1.jpg", alt: "FuturaMap Profil Siswa", caption: "Profil Siswa — Data teragregasi dari LMS Andalan School" },
            { src: "/images/projects/futuramap-tryout-1.jpg", alt: "FuturaMap Tryout 1", caption: "Dashboard Tren Tryout dan Analisis Gap SNBT" },
            { src: "/images/projects/futuramap-tryout-2.jpg", alt: "FuturaMap Tryout 2", caption: "Visualisasi tren keseluruhan nilai siswa" },
            { src: "/images/projects/futuramap-tryout-3.jpg", alt: "FuturaMap Tryout 3", caption: "Analisis performa siswa per sub-tes" },
            { src: "/images/projects/futuramap-tryout-4.jpg", alt: "FuturaMap Tryout 4", caption: "Tampilan fitur review soal tryout" },
            { src: "/images/projects/futuramap-tryout-5.jpg", alt: "FuturaMap Tryout 5", caption: "Pembetulan jawaban untuk evaluasi pembelajaran" },
            { src: "/images/projects/futuramap-kursus-1.jpg", alt: "FuturaMap Rekomendasi Kursus", caption: "Rekomendasi Kursus Hasil Generasi AI Lokal" },
